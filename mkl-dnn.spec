...
Source0  : https://github.com/intel/mkl-dnn/archive/v2.5/mkl-dnn-2.5.tar.gz
...
%prep
%setup -q -n oneDNN-2.5
cd %{_builddir}/oneDNN-2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639592942
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oneDNN-2.5/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/57997263de7280824c54d5aa8ac45fdb9d74e897
cp %{_builddir}/oneDNN-2.5/src/common/ittnotify/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/oneDNN-2.5/src/cpu/x64/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/oneDNN-2.5/src/gpu/jit/ngen/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/f9e3463caf9d198d7748315d5fcada9e89d43585
cp %{_builddir}/oneDNN-2.5/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build-avx512
