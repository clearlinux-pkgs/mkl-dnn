...
Version  : 0.20.1
Release  : 16
URL      : https://github.com/intel/mkl-dnn/archive/v0.20.1/mkl-dnn-0.20.1.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v0.20.1/mkl-dnn-0.20.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562776621
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/haswell/avx512_1/libmkldnn.so.0.20.0.0
/usr/lib64/haswell/libmkldnn.so.0
/usr/lib64/haswell/libmkldnn.so.0.20.0.0
/usr/lib64/libmkldnn.so.0
/usr/lib64/libmkldnn.so.0.20.0.0
