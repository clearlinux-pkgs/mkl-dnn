...
Version  : 3.5.3
Release  : 98
URL      : https://github.com/intel/mkl-dnn/archive/v3.5.3/mkl-dnn-3.5.3.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v3.5.3/mkl-dnn-3.5.3.tar.gz
...
%prep
%setup -q -n oneDNN-3.5.3
cd %{_builddir}/oneDNN-3.5.3
pushd ..
cp -a oneDNN-3.5.3 buildavx2
popd
pushd ..
cp -a oneDNN-3.5.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722876571
mkdir -p clr-build
pushd clr-build
