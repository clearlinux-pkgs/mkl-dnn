...
Version  : 3.8.1
Release  : 107
URL      : https://github.com/oneapi-src/oneDNN/archive/v3.8.1/oneDNN-3.8.1.tar.gz
Source0  : https://github.com/oneapi-src/oneDNN/archive/v3.8.1/oneDNN-3.8.1.tar.gz
...
%prep
%setup -q -n oneDNN-3.8.1
cd %{_builddir}/oneDNN-3.8.1
pushd ..
cp -a oneDNN-3.8.1 buildavx2
popd
pushd ..
cp -a oneDNN-3.8.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748454694
mkdir -p clr-build
pushd clr-build
