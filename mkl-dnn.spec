...
Version  : 3.6.1
Release  : 101
URL      : https://github.com/intel/mkl-dnn/archive/v3.6.1/mkl-dnn-3.6.1.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v3.6.1/mkl-dnn-3.6.1.tar.gz
...
%prep
%setup -q -n oneDNN-3.6.1
cd %{_builddir}/oneDNN-3.6.1
pushd ..
cp -a oneDNN-3.6.1 buildavx2
popd
pushd ..
cp -a oneDNN-3.6.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730909968
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdnnl.so.3.6
/V4/usr/lib64/libdnnl.so.3.6
/usr/lib64/libdnnl.so.3
/usr/lib64/libdnnl.so.3.6
