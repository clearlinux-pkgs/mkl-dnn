...
Source0  : https://github.com/intel/mkl-dnn/archive/v2.2/mkl-dnn-2.2.tar.gz
...
%prep
%setup -q -n oneDNN-2.2
cd %{_builddir}/oneDNN-2.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617289689
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oneDNN-2.2/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/c176c3939be9d8a616899982c1b92d0b7cb5731e
cp %{_builddir}/oneDNN-2.2/src/common/ittnotify/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/oneDNN-2.2/src/cpu/x64/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/oneDNN-2.2/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
