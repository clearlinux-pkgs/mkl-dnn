...
Version  : 2.7
Release  : 68
URL      : https://github.com/intel/mkl-dnn/archive/v2.7/mkl-dnn-2.7.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v2.7/mkl-dnn-2.7.tar.gz
...
%prep
%setup -q -n oneDNN-2.7
cd %{_builddir}/oneDNN-2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664326342
mkdir -p clr-build
pushd clr-build
