...
Source0  : https://github.com/intel/mkl-dnn/archive/v3.5.1/mkl-dnn-3.5.1.tar.gz
...
%prep
%setup -q -n oneDNN-3.5.1
cd %{_builddir}/oneDNN-3.5.1
pushd ..
cp -a oneDNN-3.5.1 buildavx2
popd
pushd ..
cp -a oneDNN-3.5.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721157137
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdnnl.so.3.5
/V4/usr/lib64/libdnnl.so.3.5
/usr/lib64/libdnnl.so.3
/usr/lib64/libdnnl.so.3.5
