...
Version  : 3.6
Release  : 100
URL      : https://github.com/intel/mkl-dnn/archive/v3.6/mkl-dnn-3.6.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v3.6/mkl-dnn-3.6.tar.gz
...
%prep
%setup -q -n oneDNN-3.6
cd %{_builddir}/oneDNN-3.6
pushd ..
cp -a oneDNN-3.6 buildavx2
popd
pushd ..
cp -a oneDNN-3.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729008656
mkdir -p clr-build
pushd clr-build
