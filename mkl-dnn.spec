...
Version  : 1.6.5
Release  : 32
URL      : https://github.com/intel/mkl-dnn/archive/v1.6.5/mkl-dnn-1.6.5.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v1.6.5/mkl-dnn-1.6.5.tar.gz
...
%prep
%setup -q -n oneDNN-1.6.5
cd %{_builddir}/oneDNN-1.6.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603857345
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oneDNN-1.6.5/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/aba6ee9c5143e77e6555d96c43e8a204319b10bc
cp %{_builddir}/oneDNN-1.6.5/src/cpu/x64/jit_utils/jitprofiling/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/oneDNN-1.6.5/src/cpu/x64/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/oneDNN-1.6.5/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
