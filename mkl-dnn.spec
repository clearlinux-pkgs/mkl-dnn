...
Version  : 1.4
Release  : 26
URL      : https://github.com/intel/mkl-dnn/archive/v1.4/mkl-dnn-1.4.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v1.4/mkl-dnn-1.4.tar.gz
...
%prep
%setup -q -n oneDNN-1.4
cd %{_builddir}/oneDNN-1.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587169889
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oneDNN-1.4/src/cpu/jit_utils/jitprofiling/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/oneDNN-1.4/src/cpu/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/oneDNN-1.4/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
...
/usr/usr/lib64/libmkldnn.so.1.4
...
/usr/lib64/haswell/avx512_1/libdnnl.so.1.4
/usr/lib64/haswell/libdnnl.so.1
/usr/lib64/haswell/libdnnl.so.1.4
/usr/lib64/libdnnl.so.1
/usr/lib64/libdnnl.so.1.4
