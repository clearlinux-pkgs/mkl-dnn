...
Source0  : https://github.com/intel/mkl-dnn/archive/v3.5.2/mkl-dnn-3.5.2.tar.gz
...
%prep
%setup -q -n oneDNN-3.5.2
cd %{_builddir}/oneDNN-3.5.2
pushd ..
cp -a oneDNN-3.5.2 buildavx2
popd
pushd ..
cp -a oneDNN-3.5.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722272481
mkdir -p clr-build
pushd clr-build
