...
Source0  : https://github.com/intel/mkl-dnn/archive/v3.3.4/mkl-dnn-3.3.4.tar.gz
...
%prep
%setup -q -n oneDNN-3.3.4
cd %{_builddir}/oneDNN-3.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704818867
mkdir -p clr-build
pushd clr-build
