...
Version  : 2.7.1
Release  : 70
URL      : https://github.com/intel/mkl-dnn/archive/v2.7.1/mkl-dnn-2.7.1.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v2.7.1/mkl-dnn-2.7.1.tar.gz
...
%prep
%setup -q -n oneDNN-2.7.1
cd %{_builddir}/oneDNN-2.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667432706
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libdnnl.so.2.7
/usr/lib64/glibc-hwcaps/x86-64-v4/libdnnl.so.2
/usr/lib64/glibc-hwcaps/x86-64-v4/libdnnl.so.2.7
/usr/lib64/libdnnl.so.2
/usr/lib64/libdnnl.so.2.7
