...
Version  : 3.7.2
Release  : 104
URL      : https://github.com/oneapi-src/oneDNN/archive/v3.7.2/oneDNN-3.7.2.tar.gz
Source0  : https://github.com/oneapi-src/oneDNN/archive/v3.7.2/oneDNN-3.7.2.tar.gz
...
%prep
%setup -q -n oneDNN-3.7.2
cd %{_builddir}/oneDNN-3.7.2
pushd ..
cp -a oneDNN-3.7.2 buildavx2
popd
pushd ..
cp -a oneDNN-3.7.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742442153
mkdir -p clr-build
pushd clr-build
