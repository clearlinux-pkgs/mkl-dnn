...
Source0  : https://github.com/intel/mkl-dnn/archive/v1.2.2/mkl-dnn-1.2.2.tar.gz
...
%prep
%setup -q -n mkl-dnn-1.2.2
cd %{_builddir}/mkl-dnn-1.2.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584633501
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mkl-dnn-1.2.2/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/f6957ac1701e66451ae87774564bda9cbe629a32
cp %{_builddir}/mkl-dnn-1.2.2/doc/assets/mathjax/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/mkl-dnn-1.2.2/src/cpu/jit_utils/jitprofiling/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/mkl-dnn-1.2.2/src/cpu/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/mkl-dnn-1.2.2/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
...
/usr/share/package-licenses/mkl-dnn/f6957ac1701e66451ae87774564bda9cbe629a32
