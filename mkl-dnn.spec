...
Version  : 1.0
Release  : 17
URL      : https://github.com/intel/mkl-dnn/archive/v1.0/mkl-dnn-1.0.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v1.0/mkl-dnn-1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563047917
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/haswell/avx512_1/libmkldnn.so.1.0.0.0
/usr/lib64/haswell/libmkldnn.so.0
/usr/lib64/haswell/libmkldnn.so.1.0.0.0
/usr/lib64/libmkldnn.so.0
/usr/lib64/libmkldnn.so.1.0.0.0
