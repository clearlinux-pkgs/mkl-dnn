...
Version  : 2.6.2
Release  : 66
URL      : https://github.com/intel/mkl-dnn/archive/v2.6.2/mkl-dnn-2.6.2.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v2.6.2/mkl-dnn-2.6.2.tar.gz
...
%prep
%setup -q -n oneDNN-2.6.2
cd %{_builddir}/oneDNN-2.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662847467
mkdir -p clr-build
pushd clr-build
