...
Source0  : https://github.com/intel/mkl-dnn/archive/v2.7.2/mkl-dnn-2.7.2.tar.gz
...
%prep
%setup -q -n oneDNN-2.7.2
cd %{_builddir}/oneDNN-2.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669050875
mkdir -p clr-build
pushd clr-build
