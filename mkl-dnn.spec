...
Source0  : https://github.com/intel/mkl-dnn/archive/v3.4.1/mkl-dnn-3.4.1.tar.gz
...
%prep
%setup -q -n oneDNN-3.4.1
cd %{_builddir}/oneDNN-3.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711838396
mkdir -p clr-build
pushd clr-build
