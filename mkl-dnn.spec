...
Version  : 0.17.4
Release  : 12
URL      : https://github.com/intel/mkl-dnn/archive/v0.17.4.tar.gz
Source0  : https://github.com/intel/mkl-dnn/archive/v0.17.4.tar.gz
...
%prep
%setup -q -n mkl-dnn-0.17.4
%patch1 -p1
pushd ..
cp -a mkl-dnn-0.17.4 buildavx2
popd
pushd ..
cp -a mkl-dnn-0.17.4 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1550018579
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/haswell/avx512_1/libmkldnn.so.0.17.4.0
/usr/lib64/haswell/libmkldnn.so.0
/usr/lib64/haswell/libmkldnn.so.0.17.4.0
/usr/lib64/libmkldnn.so.0
/usr/lib64/libmkldnn.so.0.17.4.0
