...
Source0  : https://github.com/intel/mkl-dnn/archive/v2.3.2/mkl-dnn-2.3.2.tar.gz
...
%prep
%setup -q -n oneDNN-2.3.2
cd %{_builddir}/oneDNN-2.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628531953
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oneDNN-2.3.2/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/57997263de7280824c54d5aa8ac45fdb9d74e897
cp %{_builddir}/oneDNN-2.3.2/src/common/ittnotify/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/oneDNN-2.3.2/src/cpu/x64/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/oneDNN-2.3.2/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
...
/usr/usr/lib64/libmkldnn.so.2.3
...
/usr/lib64/haswell/avx512_1/libdnnl.so.2.3
/usr/lib64/haswell/libdnnl.so.2
/usr/lib64/haswell/libdnnl.so.2.3
/usr/lib64/libdnnl.so.2
/usr/lib64/libdnnl.so.2.3
