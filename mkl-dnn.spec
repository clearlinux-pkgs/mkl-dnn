...
Source0  : https://github.com/intel/mkl-dnn/archive/v2.1.1/mkl-dnn-2.1.1.tar.gz
...
%prep
%setup -q -n oneDNN-2.1.1
cd %{_builddir}/oneDNN-2.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614360286
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oneDNN-2.1.1/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/c176c3939be9d8a616899982c1b92d0b7cb5731e
cp %{_builddir}/oneDNN-2.1.1/src/cpu/x64/jit_utils/jitprofiling/LICENSE.BSD %{buildroot}/usr/share/package-licenses/mkl-dnn/be8f76850d5fd6458ff339a1a7df86bbec3e5366
cp %{_builddir}/oneDNN-2.1.1/src/cpu/x64/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/mkl-dnn/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/oneDNN-2.1.1/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/mkl-dnn/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
