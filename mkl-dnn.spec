...
Source0  : https://github.com/intel/mkl-dnn/archive/v0.17.2.tar.gz
...
%prep
%setup -q -n mkl-dnn-0.17.2
%patch1 -p1
pushd ..
cp -a mkl-dnn-0.17.2 buildavx2
popd
pushd ..
cp -a mkl-dnn-0.17.2 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1545276027
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/haswell/avx512_1/libmkldnn.so.0.17.2.0
/usr/lib64/haswell/libmkldnn.so.0
/usr/lib64/haswell/libmkldnn.so.0.17.2.0
/usr/lib64/libmkldnn.so.0
/usr/lib64/libmkldnn.so.0.17.2.0
